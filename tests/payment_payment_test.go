...
type stubPurchaseRepoSimple struct{}

func (stubPurchaseRepoSimple) Create(ctx context.Context, p *domainpurchase.Purchase) (int64, error) {
	return 1, nil
}
func (stubPurchaseRepoSimple) FindByInvoiceTypeAndStatus(ctx context.Context, t domainpurchase.InvoiceType, s domainpurchase.Status) (*[]domainpurchase.Purchase, error) {
	return nil, nil
}
func (stubPurchaseRepoSimple) FindById(ctx context.Context, id int64) (*domainpurchase.Purchase, error) {
	return nil, nil
}
func (stubPurchaseRepoSimple) UpdateFields(ctx context.Context, id int64, m map[string]interface{}) error {
	return nil
}
func (stubPurchaseRepoSimple) MarkAsPaid(ctx context.Context, id int64) error { return nil }
...
func TestCreatePurchaseUnknownType(t *testing.T) {
	svc := payment.NewPaymentService(nil, stubPurchaseRepoSimple{}, nil, nil, nil, nil, nil, nil, nil, nil)
